(function(global, factory) {
  ...
  var ModuleLoaderTool = /** @class */ (function() {
    ...
    ModuleLoaderTool.prototype.loadBulkBundles = function(filterFn) {
      var _this = this;
      return Promise.all(
        this.bundlesList.filter(filterFn).map(function(manifest) {
          return _this.loadBundleByManifest(manifest);
        })
      ).then(function(compiledBundles) {
    ...
    ModuleLoaderTool.prototype.defineManifestType = function(
      type,
      typeMatcher,
      modulePreprocessor,
      modulePostprocessor
    ...
    ModuleLoaderTool.prototype.load = function(filterFn) {
      ...
      return fetch(this.entrypoint.manifestUrl)
        ...
        .then(function(bundlesText) {
          return JSON.parse(bundlesText);
        })
        .then(
          // tslint:disable-next-line
          function(bundlesObj) {
        ...
        .then(function() {
          return _this.loadBulkBundles(function(manifest) {
            return manifest.loadStrategy === exports.ModuleLoadStrategy.BLOCK;
          });
        });
    };
    // tslint:disable-next-line
    ModuleLoaderTool.prototype.start = function(runner) {
      ...
      return Promise.resolve()
        ...
        .then(function() {
          return _this.loadBulkBundles(function(manifest) {
            return manifest.loadStrategy === exports.ModuleLoadStrategy.IMMEDIATELY;
          });
        });
    };
    ModuleLoaderTool.prototype.loadBundleByManifest = function(manifest) {
      ...
      this.loadersCache[manifest.name] = this.manifestProcessors
        ...
        .then(function() {
          return fetchBundleSource(serviceFileUrl);
        })
        .then(function(source) {
          return compileSource(source, _this.dependencies);
        })
    ...
    ModuleLoaderTool.prototype.loadBundleByName = function(name) {
      var manifest = this._bundlesList.find(function(m) {
        return m.name === name;
      });
      if (!manifest) {
